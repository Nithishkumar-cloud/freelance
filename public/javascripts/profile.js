const sessionid = localStorage.getItem('sessionid');
        ...
        var x = axios.post("https://worried-gold-shoulder-pads.cyclic.app/ids", { id: sessionid });
            ...
            if(details.Phone===""){
                ...
                //  speech.lang = 'ta-IN';
                 ...
                 const timeout=setTimeout(()=>{
                  ...
                  var c=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/phoneupdate", { data: details });
            ...
            if(details.WhatsappPhone===""){
                ...
                //  speech.lang = 'ta-IN';
                 ...
                 const timeout=setTimeout(()=>{
                   ...
                   var d=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/WhatsappPhoneUpdate", { data: details });
            ...
            if(details.dob===""){
                document.getElementById('doberr').style.display="block";
                 ...
                 const timeout=setTimeout(()=>{
                   ...
                   var c=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/dobupdate", { data: details });
            ...
            if(details.address===""){
                document.getElementById('adderr').style.display="block";
                 ...
                 const timeout=setTimeout(()=>{
                   ...
                   var c=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/addressupdate", { data: details });
        ...
        async function peraddress() {
            ...
            if(details.peraddress===""){
                 ...
                 const timeout=setTimeout(()=>{
                  ...
                  var c=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/PermanentAddressChange", { data: details });
            ...
            if(details.Disabilityper===""){
                document.getElementById('diserr').style.display="block";
                 ...
                 const timeout=setTimeout(()=>{
                   ...
                   var c=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/disperupdate", { data: details });
            ...
            if(details.profession===""){
                document.getElementById('proerr').style.display="block";
                 ...
                 const timeout=setTimeout(()=>{
                  ...
                  var c=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/profession",{data:details});
        ...
        async function pinchange() {
            ...
            if(details.oldpass === ""){
              ...
              let speech=new SpeechSynthesisUtterance("Please Enter Your oldpin");
               ...
               let x=await axios.post("https://worried-gold-shoulder-pads.cyclic.app/pinupdate", { data: details });
